...
try:  # package-relative when imported as src.uq_bakeoff
    ...
    from eval.metrics_calibrated import aurc, hoeffding_halfwidth, spearman, normal_quantile
...
def extract_method_arrays(
    ...
    """
    import torch  # lazy
    from model.snr_map_head import SupervisedSNRMapHead
    from model.uq_heads import (
